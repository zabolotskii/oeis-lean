...
The sequence [A281487](https://oeis.org/A281487) is defined by the relation $a(n+1) = -\sum_{d|n} a(d)$, with $a(1)=1$. The file [SumOverDivisors.lean](Oeis/SumOverDivisors.lean) ([docs](https://colt-browning.github.io/oeis-lean/docs/Oeis/SumOverDivisors.html)) contains the proof that $a(n) \geqslant 0$ if $n$ is odd and $a(n) \leqslant 0$ if $n$ is even.
